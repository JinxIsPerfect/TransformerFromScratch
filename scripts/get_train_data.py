...
if __name__ == "__main__":
    ...
    tokenizer_json_path = "/mnt/miaohua/lizehua/workspace/basic/data/bpe_tokenizer/tokenizer.json"

    build_random_data_bin(
        input_txt="/mnt/miaohua/lizehua/workspace/basic/data/TinyStoriesV2-GPT4-train.txt",
        tokenizer_json=tokenizer_json_path,
        output_bin="/mnt/miaohua/lizehua/workspace/basic/data/TinyStoriesV2.bin",
